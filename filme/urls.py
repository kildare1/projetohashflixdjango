# url  -  view  -  template    -> Sempre que vamos construir um site, temos que fazer esses 03 itens
...
urlpatterns = [
    path('', Homepage.as_view(), name='homepage'), #Homepage.as_vies() Função criada na Filme/views e name='homepage
